        ...
        <ha-card @click=${() => this._handleClick()}>
          ...
          <div class="air-quality-rows">
            <div class="air-quality-row">
              <span class="air-quality-label">${localize('summary.air_quality_row_quality')}</span>
              <span class="air-quality-status" style="color: ${this._getAirQualityStatusColor(qualityStatus)};">
                ${qualityStatus === 'none'
                  ? localize('summary.air_quality_row_not_set')
                  : localize(`air_quality.${qualityStatus}`)}
              </span>
            </div>
            <div class="air-quality-row">
              <span class="air-quality-label">${localize('summary.air_quality_row_humidity')}</span>
              <span class="air-quality-status" style="color: ${this._getAirQualityStatusColor(humidityStatus)};">
                ${humidityStatus === 'none'
                  ? localize('summary.air_quality_row_not_set')
                  : localize(`air_quality.${humidityStatus}`)}
              </span>
            </div>
            <div class="air-quality-row">
              <span class="air-quality-label">${localize('summary.air_quality_row_temperature')}</span>
              <span class="air-quality-status" style="color: ${this._getAirQualityStatusColor(temperatureStatus)};">
                ${temperatureStatus === 'none'
                  ? localize('summary.air_quality_row_not_set')
                  : localize(`air_quality.${temperatureStatus}`)}
              </span>
            </div>
          </div>
        </ha-card>
